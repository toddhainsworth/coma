defmodule ComaTest do
  ...
  test "write_row/3 when all arguments are valid" do
    assert Coma.write_row(["test", "this", "out"], "test/fixtures/my_csv.csv", :overwrite)
      == { :ok, ["test", "this", "out"] }
  ...
  test "write_row/3 when the file does not exist" do
    ...
    assert Coma.write_row(["test", "this", "out"], "test/fixtures/does_not_exist", :overwrite)
      == { :ok, ["test", "this", "out"] }
  ...
  test "write_row/3 when mode is :append" do
    Coma.write_row(["test", "this", "out"], "test/fixtures/append_to_this.csv", :append)
    Coma.write_row(["foo", "the", "bar"], "test/fixtures/append_to_this.csv", :append)
  ...
  test "write_row/3 when mode is :overwrite" do
    Coma.write_row(["test", "this", "out"], "test/fixtures/overwrite_this.csv", :overwrite)
    Coma.write_row(["foo", "the", "bar"], "test/fixtures/overwrite_this.csv", :overwrite)
  ...
  test "write_row/3 when mode is not included" do
    Coma.write_row(["test", "this", "out"], "test/fixtures/append_to_this.csv")
    Coma.write_row(["foo", "the", "bar"], "test/fixtures/append_to_this.csv")
  ...
  test "write_row/3 when mode is not a supported type" do
    Coma.write_row(["test", "this", "out"], "test/fixtures/append_to_this.csv", :foo)
    Coma.write_row(["foo", "the", "bar"], "test/fixtures/append_to_this.csv", :foo)
